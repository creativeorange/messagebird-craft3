 ...
 * Messagebird Helper
 * 
 * A special thanks to Pixel & Tonic, Inc. <support@pixelandtonic.com>
 * This helper is very similar to WebhooksHelper in the craftcms/webhooks packages.
 */
class MessagebirdHelper
{
    ...
    {
        return Craft::$app->getCache()->getOrSet('messagebird.classSuggestions', function() {
            $classes = [];
